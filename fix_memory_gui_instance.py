                    ...
                    if params_start > 0 and params_end > params_start:
                        ...
                        if method_body_start > 0:
                            ...
                            if next_line > 0:
                                ...
                                updated_content = updated_content[:next_line] + gui_instance_line + updated_content[next_line:]
                                
                                # Modify any references to gui_instance to use self.gui_instance
                                updated_content = updated_content.replace("gui_instance.memory_viz", "self.gui_instance.memory_viz")
