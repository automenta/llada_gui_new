...
# Import Titan Memory
from ..titan_memory import TitanMemorySystem, TitanMemoryConfig, TitanMemoryModel
...
class TitanMemoryGuidance:
    ...
    def apply_memory_guidance(self, 
        ...
        try:
            ...
            for token_id in range(min(vocab_size, len(self.token_embeddings) if self.token_embeddings is not None else 0)):
                token_embedding = self.get_token_embedding(token_id)
